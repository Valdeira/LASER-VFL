...
def create_vocab(file):
    with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+file, 'rb') as fp:
...
def create_batches(batch_size,chart_flag):
    with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'hadmDic', 'rb') as fp:
        hids = pickle.load(fp)
    
    batchDict={}
    with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'dataDic', 'rb') as fp:
        dataDic = pickle.load(fp)
    if chart_flag:
        batchChartDict={}
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'dataChartDic', 'rb') as fp:
...
def init(diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag):
        ...
        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'ethVocabDict', 'wb') as fp:
            pickle.dump(ethVocabDict, fp)
            
        ageVocabDict=create_vocab('ageVocab')
        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'ageVocabDict', 'wb') as fp:
            pickle.dump(ageVocabDict, fp)
        
        genderVocabDict=gender_vocab()
        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'genderVocabDict', 'wb') as fp:
            pickle.dump(genderVocabDict, fp)
            
        insVocabDict=create_vocab('insVocab')
        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'insVocabDict', 'wb') as fp:
        ...
        vocab_d = {
                    "cond_vocab_size": len(condVocabDict),
                    "proc_vocab_size": len(procVocabDict),
                    "med_vocab_size": len(medVocabDict),
                    "out_vocab_size": len(outVocabDict),
                    "chart_vocab_size": len(chartVocabDict),
                    "lab_vocab_size": len(labVocabDict),
                    "eth_vocab": ethVocabDict,
                    "gender_vocab": genderVocabDict,
                    "age_vocab": ageVocabDict,
                    "ins_vocab": insVocabDict,
                    }
...
def init_read(batch_size,diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag):
        ...
        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'ethVocabDict', 'rb') as fp:
            ethVocabDict= pickle.load(fp)

        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'ageVocabDict', 'rb') as fp:
            ageVocabDict= pickle.load(fp)

        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'genderVocabDict', 'rb') as fp:
            genderVocabDict= pickle.load(fp)
            
        with open('data/MIMIC-IV-Data-Pipeline/data/dict/'+'insVocabDict', 'rb') as fp:
...
def get_meta():
    with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'metaDic', 'rb') as fp:
        meta = pickle.load(fp)
    if "Lab" in meta.keys():
...
def get_batches():
    with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'batchDict', 'rb') as fp:
...
def get_batch_data(key,data,diag_flag,proc_flag,out_flag,chart_flag,med_flag,lab_flag): 
    ...
    with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'metaDic', 'rb') as fp:
        meta = pickle.load(fp)
    if diag_flag:
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'condVocabDict', 'rb') as fp:
            condVocabDict = pickle.load(fp)
    if proc_flag:
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'procVocabDict', 'rb') as fp:
            procVocabDict = pickle.load(fp)
    if med_flag:
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'medVocabDict', 'rb') as fp:
            medVocabDict = pickle.load(fp)
    if out_flag:
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'outVocabDict', 'rb') as fp:
            outVocabDict = pickle.load(fp)
    if lab_flag:
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'labVocabDict', 'rb') as fp:
            labVocabDict = pickle.load(fp)
    ...
    if chart_flag:
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'chartVocabDict', 'rb') as fp:
            chartVocabDict = pickle.load(fp)
        with open ('data/MIMIC-IV-Data-Pipeline/data/dict/'+'batchChartDict', 'rb') as fp:
