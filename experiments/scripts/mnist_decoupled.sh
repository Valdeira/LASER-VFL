# with wandb: ./experiments/scripts/mnist_decoupled_powerset.sh 3 0
# without wandb: ./experiments/scripts/mnist_decoupled_powerset.sh 3 0 false
CUDA_ID=$1
SEED=$2
